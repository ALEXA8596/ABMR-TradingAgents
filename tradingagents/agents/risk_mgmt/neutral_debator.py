...
"""
        ...
        # Append the new argument to the history
        try:
        ...
        # Append the new argument to the neutral_history
        try:
            neutral_history_list = json.loads(neutral_history) if neutral_history else []
        except Exception:
            neutral_history_list = []
        neutral_history_list.append(argument_json)
        new_neutral_history = json.dumps(neutral_history_list)
